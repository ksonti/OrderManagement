...
import com.returnordermanag.webPortal.model.JwtTokenResponse;
...
public class HomeController {
	...
	public @ResponseBody JwtTokenResponse userLogin(@RequestParam("username") String username, @RequestParam("password") String password) {
